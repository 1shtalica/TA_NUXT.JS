...
<template>
  <footer class="w-full bg-slate-900 text-slate-200 py-10">
    <div
        ...
        <div class="md:col-span-5 flex flex-col gap-6">
          <div class="space-y-3">
            ...
            <p class="text-slate-400 text-sm md:text-base leading-relaxed max-w-sm">
              ...
              manajemen event terpercaya di Indonesia.
            </p>
          </div>
          ...
          <div class="flex gap-2">
            <Button
              ...
              variant="ghost"
              size="icon"
              class="rounded-full bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white transition-all"
            >
              <a
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2 items-start">
              <Button
                as-child
                variant="link"
                class="p-0 h-auto text-slate-400 hover:text-white transition-colors justify-start font-normal"
              >
              ...
              <Button
                ...
                class="p-0 h-auto text-slate-400 hover:text-white transition-colors justify-start font-normal"
              >
                <NuxtLink to="/">Pusat Bantuan</NuxtLink>
              </Button>
              <Button
                as-child
                variant="link"
                class="p-0 h-auto text-slate-400 hover:text-white transition-colors justify-start font-normal"
              >
                <NuxtLink to="/">Jadi Partner</NuxtLink>
              </Button>
            </div>
          </div>
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2 items-start">
              ...
              <Button
                ...
                class="p-0 h-auto text-slate-400 hover:text-white transition-colors justify-start font-normal"
              >
                <NuxtLink to="/">Pedoman Komunitas</NuxtLink>
              </Button>
            </div>
          </div>
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2 items-start">
              <Button
                ...
                class="p-0 h-auto text-slate-400 hover:text-white transition-colors justify-start font-normal"
              >
                <NuxtLink to="/">Email Support</NuxtLink>
              </Button>
              <Button
                as-child
                variant="link"
